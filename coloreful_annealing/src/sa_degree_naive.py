...
class SymmetryAproximator(Annealer):
    def __init__(self, state, A, B, mfp, modification, division_constant):
        ...
        degree_distribution = sum(self.A,0)
        ...
        # compute the inverse of the distance matrix - create a form of similariy measure. Add 0.2 to avoid division by zero. 
        # Is 0.2 optimal? Let it be a parameter of the proposed function.
        self.dist_nodes_matrix_inv = 1./(self.division_constant + dist_nodes_matrix) 
    ...
    def move(self):
        if self.modification:
            ...
            dist_nodes = self.dist_nodes_matrix_inv[self.state[a]]
...
def annealing(a, b=None, temp=1, steps=20000, runs=1, fp=0, modification = True, division_constant = 0.2):
